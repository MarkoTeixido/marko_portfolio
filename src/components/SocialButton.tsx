...
const SocialButton: React.FC<Props> = ({ children, bgColor = "black" }) => {
  ...
  return (
    <button className={`group h-12 w-12 bg-white ${bgHoverColorClass} rounded-full transition-colors duration-200 ease-in-out flex justify-center items-center`} aria-label="social button">
